...
class TranslatorTest < parent_module
  ...
  def test_namespaced_controller
    ...
    assert_not_nil assigns
    # Test that controller could translate
    assert_equal I18n.t('admin.home.index.title'), assigns(:page_title)
  end
  ...
  def test_namespaced_view_show
    @controller = Admin::HomeController.new
    get :index
    assert_response :success
    welcome_home = I18n.translate('admin.home.index.welcome_home')

    assert_match welcome_home, @response.body
  end
